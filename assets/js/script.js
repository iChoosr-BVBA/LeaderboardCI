        ...
        if (msg[name]['status'] == 'Failed') {
            ...
            if (msg[name]['accomplishments'] ) {
                if (msg[name]['accomplishments']['badge']) {
                    ...
                    gridster.add_widget('<li class="new"><div class="playerlist"><div class="player"><div class="box"><div class="headshot"><img src=' + msg[name]['gravUrl'] + ' border="0" style="border: 1px solid black;"><img src=' + msg[name]['accomplishments']['image'] + ' style="position: absolute; top: 17px; left:44px; opacity:0.5;"></div><div class="details wide"><div class="det"><div class="name">' + msg[name]['name'] + '</div><div class="status">' + msg[name]['status'] + '</div></div><div class="badge font-effect-fire-animation" >' + msg[name]['accomplishments']['text'] + '</div></div></div><div class="box"><div class="points">' + msg[name]['points'] + '</div></div></div></div></li>', 2, 1, 4, 1);
                }
            } else {
                if (msg[name]['points'] < 0) {
